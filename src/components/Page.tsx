...
const Page = ({
  ...
  <div className="relative flex min-h-screen items-stretch justify-center bg-stone-200 transition duration-700 dark:bg-zinc-800">
    <div
      className={[
        "grid w-full grid-rows-[auto_auto_1fr] bg-white bg-cover bg-center transition duration-700 dark:bg-neutral-600 sm:m-8 sm:w-[41rem] sm:rounded-xl sm:shadow-lg",
        backgroundClassName,
